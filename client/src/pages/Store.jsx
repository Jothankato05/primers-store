...
export default function Store() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold">Primers Store</h1>
        <p className="text-gray-600 mt-1">Browse verified apps — every app reviewed for quality and safety.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <h3 className="mt-4 text-lg font-semibold text-gray-700">No apps found</h3>
              ...
              {[...Array(totalPages)].map((_, i) => (
                <button
                  ...
                  className={`w-9 h-9 rounded-lg text-sm font-medium transition-colors ${
                    page === i + 1 ? 'bg-primer-600 text-white' : 'hover:bg-gray-100 text-gray-700'
                  }`}
                >
                  {i + 1}
                </button>
